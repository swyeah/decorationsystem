        ...
        <div class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-0">
            ...
            <div class="row">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-heading">意向客户
                        <div class="pull-right">总共${pageInfo.pages }页，总共${pageInfo.total }条记录</div>
                    </div>
                    <div class="panel-body">
                        意向客户为市场人员已指定设计师的客户，需要设计师跟客户预约时间，签订设计协议,上传合同审批
                    </div>

                    <div class="row" style="margin-left: 10px;">
                        <form class="form-horizontal" action="${pageContext.request.contextPath}/common_intent/consumer_management_intent" method="get">
                            <div class="col-sm-2">
                                start
                        ...
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${registrationTables}" var="r" varStatus="i" >
                                <tr>
                                    ...
                                    <td>${r.appointment.appointmentTime }</td>
                                    <td>
                                        <div  class="btn-group btn-group-xs" role="group">
                                            ...
                                            <button type="button"   class="btn btn-info" id="tracking" onclick="appointment('${r.registrationId}')">预约时间</button>
                                            <button type="button"   onclick="window.location.href='${pageContext.request.contextPath}/common_intent/deposit?registrationId=${r.registrationId}&employeeId=${r.designer.employeeId}'" class="btn btn-primary">定金协议</button>
                        ...
                        <div class="col-sm-6 col-sm-offset-3">
                            <nav aria-lable="Page navigation">
                                <ul class="pagination">
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/common_intent/consumer_management_intent?pageNum=1&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}">首页</a></li>

                                    <c:if test="${pageInfo.hasPreviousPage  }">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/common_intent/consumer_management_intent?pageNum=${pageInfo.pageNum-1}&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}" aria-label="Previous">
                                    ...
                                    <c:forEach items="${pageInfo.navigatepageNums  }" var="page">
                                        <c:if test="${page!=pageInfo.pageNum && page>pageInfo.pageNum-3 &&page<pageInfo.pageNum}">
                                            <li><a href="${pageContext.request.contextPath}/common_intent/consumer_management_intent?pageNum=${page}&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}">${page}</a></li>
                                        </c:if>
                                        <c:if test="${page==pageInfo.pageNum}">
                                            <li class="active"><a href="${pageContext.request.contextPath}/common_intent/consumer_management_intent?pageNum=${page}&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}">${page}</a></li>
                                        </c:if>
                                        <c:if test="${page!=pageInfo.pageNum && page<pageInfo.pageNum+3 &&page>pageInfo.pageNum}">
                                            <li><a href="${pageContext.request.contextPath}/common_intent/consumer_management_intent?pageNum=${page}&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}">${page}</a></li>
                                        </c:if>
                                    ...
                                    <c:if test="${pageInfo.hasNextPage }">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/common_intent/consumer_management_intent?pageNum=${pageInfo.pageNum+1 }&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}" aria-label="Next">
                                                <span aria-hidden="true">&raquo;</span>
                                            </a>
                                        </li>
                                    </c:if>

                                    <li><a href="${pageContext.request.contextPath}/common_intent/consumer_management_intent?pageNum=${pageInfo.pages}&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}">末页</a></li>
...
<script type="text/javascript">
    ...
    function appointment(registrationId) {
        window.location.href="${pageContext.request.contextPath}/common_intent/consumer_appointment?registrationId="+registrationId;
    }
    /*指定设计师按钮响应方法*/
