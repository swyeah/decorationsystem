        ...
        <div class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-0">
            <div class="row">
                <ol class="breadcrumb">
                    <li><a href="#">首页</a></li>
                    <li>客户管理</li>
                    <li class="active">完工客户</li>
                </ol>
            </div>
            <div class="row">
                <div class="panel panel-primary">
                    <!-- Default panel contents -->
                    <div class="panel-heading">完工客户
                        <div class="pull-right">总共${pageInfo.pages }页，总共${pageInfo.total }条记录</div>
                    </div>
                    <div class="panel-body">
                       完工客户为完成装修工程的客户，可查看保修期
                    </div>

                    <div class="row" style="margin-left: 10px; margin-bottom: 10px;">
                        <form class="form-horizontal" action="${pageContext.request.contextPath}/common_over/common_management_over" method="get">
                            <div class="col-sm-2">
                                start
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div  class="btn-group btn-group-xs" role="group">
                                            <button type="button" id="guarantee" onclick="guarantee('${r.registrationId}')"  class="btn btn-primary">修改保修期限</button>
                                        </div>
                                    </td>
                                </tr>
                            </c:forEach>
                        ...
                        <div class="col-sm-6 col-sm-offset-3">
                            <nav aria-lable="Page navigation">
                                <ul class="pagination">
                                    ...
                                    <li><a href="${pageContext.request.contextPath}/common_over/common_management_over?pageNum=1&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}">首页</a></li>

                                    <c:if test="${pageInfo.hasPreviousPage  }">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/common_over/common_management_over?pageNum=${pageInfo.pageNum-1}&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}" aria-label="Previous">
                                    ...
                                    <c:forEach items="${pageInfo.navigatepageNums  }" var="page">
                                        <c:if test="${page!=pageInfo.pageNum && page>pageInfo.pageNum-3 &&page<pageInfo.pageNum}">
                                            <li><a href="${pageContext.request.contextPath}/common_over/common_management_over?pageNum=${page}&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}">${page}</a></li>
                                        </c:if>
                                        <c:if test="${page==pageInfo.pageNum}">
                                            <li class="active"><a href="${pageContext.request.contextPath}/common_over/common_management_over?pageNum=${page}&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}">${page}</a></li>
                                        </c:if>
                                        <c:if test="${page!=pageInfo.pageNum && page<pageInfo.pageNum+3 &&page>pageInfo.pageNum}">
                                            <li><a href="${pageContext.request.contextPath}/common_over/common_management_over?pageNum=${page}&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}">${page}</a></li>
                                        </c:if>
                                    ...
                                    <c:if test="${pageInfo.hasNextPage }">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/common_over/common_management_over?pageNum=${pageInfo.pageNum+1 }&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}" aria-label="Next">
                                                <span aria-hidden="true">&raquo;</span>
                                            </a>
                                        </li>
                                    </c:if>

                                    <li><a href="${pageContext.request.contextPath}/common_over/common_management_over?pageNum=${pageInfo.pages}&startTime=${searchContent.startTime}&endTime=${searchContent.endTime}&sname=${searchContent.sname}&provinceId=${searchContent.provinceId}&cityId=${searchContent.cityId}">末页</a></li>
...
<script type="text/javascript">
    ...
    function guarantee(registrationId) {
        ...
        $.post({
            url: "${pageContext.request.contextPath}/common_over/getGuarantee",
            dataType : "json",//预期服务器返回的类型c
            contentType: "application/json",
...
//        live: 'disabled',
    ...
    $('#sub').click(function() {
        ...
        if($('#guarateeform').data("bootstrapValidator").isValid()){
            ...
            $.post({
                url: "${pageContext.request.contextPath}/common_over/changeGuarantee",
                dataType : "json",//预期服务器返回的类型c
                contentType: "application/json",
                data: formdata,
                success : function (data) {
