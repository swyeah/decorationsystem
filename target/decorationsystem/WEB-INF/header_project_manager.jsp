    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right visible-xs">
                ...
                <li class="dropdown">
                    <a href="${pageContext.request.contextPath}/material_management/material" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-wrench"></i>
                        <span>材料查看</span><span class="caret"></span></a>
                </li>
                <li >
