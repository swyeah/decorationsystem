        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right visible-xs">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="${pageContext.request.contextPath}/designer_show/designer_show_management">户型图管理</a></li>
                ...
                <li >
                    <a href="${pageContext.request.contextPath}/webSocket/employee_communications">
                        <i class="glyphicon glyphicon-comment"></i> <span>在线聊天</span>
                    </a>
                </li>
                <li >
        ...
        <section  class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="treeview" >
                    ...
                    <ul class="treeview-menu">
                        <li><a href="${pageContext.request.contextPath}/designer_show/designer_up">上传设计展示</a></li>
                        <li><a href="${pageContext.request.contextPath}/designer_show/designer_show_management">设计展示管理</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="${pageContext.request.contextPath}/material_management/material">
